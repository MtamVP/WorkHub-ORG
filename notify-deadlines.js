(function () {
    ...
    // wh-org has no single fixed team like wh-fin's 'finance' — script.js's activeGroup
    // (see script.js:15) always resolves to 'all' since CURRENT_GROUP_KEY is never set
    // anywhere in this app, and API.task.listMine treats 'all' as "no group filter"
    // (skips the .eq('group_key', ...) clause). Match that behavior here.
    var GROUP_KEY = 'all';
